...
export default function DeleteFilesPrompt(props: DeleteFilesPromptProps) {
  ...
  return (
    <AlertDialog isOpen={deleteFiles.promptOpen} leastDestructiveRef={cancelRef} onClose={handleCancel}>
      <AlertDialogOverlay>
        <AlertDialogContent>
          ...
          <AlertDialogBody>
            ...
            <VStack w="full" alignItems="left" mt={2} mb={6}>
              {deleteFiles.filesToDelete.map((fileToDelete) => (
                <Fragment key={fileToDelete.id}>
                  ...
                  {fileToDelete.isDir && (
                    <HStack w="full" justifyContent="left" alignItems="center" mt="0!important">
                      <FiAlertTriangle color="red" />
                      <Text fontSize="sm" color="red" mt="0!important">
                        All files under this directory will be deleted too
                      </Text>
                    </HStack>
                  )}
                </Fragment>
