...
export default function SaveDashboardPrompt(props: SaveDashboardPromptProps) {
  ...
  return (
    <AlertDialog isOpen={props.promptOpen} leastDestructiveRef={cancelRef} onClose={handlePromptClose}>
      <AlertDialogOverlay>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <Button ref={cancelRef} onClick={handlePromptClose} isDisabled={props.dashboardSaving}>
              Cancel
            </Button>
            <Button
              colorScheme="blue"
              ...
              loadingText={"Saving"}
              isDisabled={dashboardName.length === 0 || props.dashboardSaving}
            >
              Save
            </Button>
          </AlertDialogFooter>
