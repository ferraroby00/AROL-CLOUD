...
function WidgetControlPanel(props: WidgetControlPanelProps) {
  ...
  function refreshSensorData() {
    ...
    ToastHelper.makeToast(toast, "Refreshing sensor data", "info");
  }
  ...
  return (
    ...
    >
      <Input
        ...
        value={widgetName}
        onBlur={(e) =>
          props.handleWidgetModified("rename", {
            id: props.widgetID,
            name: e.target.value,
          })
        }
      ...
      >
        {props.numSensorsMonitoring > 0 && (
          <HStack flexWrap={"nowrap"}>
            ...
            />
            {!props.sensorDataError && props.widgetMaxSensors > 1 && (
              <WidgetInfoPopover
        ...
        {props.dashboardPermissionsModify && (
          <Menu>
            <MenuButton as={IconButton} icon={<FiMoreVertical />} variant="ghost" mx={"0!important"} />
            <Portal>
              <MenuList shadow={"2xl"}>
                <MenuItem icon={<FiPlus />} onClick={() => props.setSensorsModalOpen(true)}>
                  Add sensors
                </MenuItem>
                <MenuItem icon={<FiSettings />} onClick={() => props.setSettingsModalOpen(true)}>
                  Widget settings
                </MenuItem>
                <MenuItem
                  icon={<FiTrash2 />}
