...
export default function DashboardControlPanel(props: DashboardControlPanelProps) {
  ...
  return (
    <VStack w={"full"}>
      <HStack w={"full"} justifyContent={"center"} alignItems={"baseline"} my={2}>
            ...
            <Portal>
              <PopoverContent shadow={"2xl"}>
                ...
                <PopoverBody>
                  {props.dashboard.numUnsavedChanges > 0 && (
                    <Text fontSize={"md"}>
                      There are {props.dashboard.numUnsavedChanges} unsaved changes. Please consider saving your
                      modifications as soon as possible so not to risk them being lost.
                    </Text>
                  )}
                  {props.dashboard.numUnsavedChanges === 0 && (
                    <Text fontSize={"md"}>All changes are saved. You can safely navigate away from the dashboard.</Text>
                  )}
                </PopoverBody>
              </PopoverContent>
            </Portal>
      ...
      <HStack w={"full"} justifyContent={"left"} alignItems={"stretch"} mt={"0!important"}>
        <Button
          colorScheme="blue"
          variant="ghost"
            ...
            >
              ...
              <MenuItem
                ...
                isDisabled={
                  props.dashboard.grid.widgets.length === 0 ||
                  props.dashboardLoading ||
                  !props.dashboardPermissions.write
                }
