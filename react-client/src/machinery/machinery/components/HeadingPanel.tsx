...
export default function HeadingPanel(props: HeadingPanelProps) {
  ...
  const [dashboardNotSavedPromptObject, setDashboardNotSavedPromptObject] = useState<{ open: boolean; type: string }>({
    open: false,
    type: "",
  });
  ...
  function handleNewDashboardButtonClicked() {
    if (props.dashboard.numUnsavedChanges) {
      ...
      props.setDashboard(new Dashboard());
    }
  }
      ...
      <VStack w="full">
        <HStack w="full">
          ...
          >
            ...
            <Heading fontSize={"2xl"} fontFamily={"body"} whiteSpace={"nowrap"} mb={"0!important"}>
            ...
            <Text color={"black"} whiteSpace={"nowrap"} mt={"0!important"} mb={4}>
          ...
          {props.type === "dashboard" && (
            <VStack w="250px" h="full" alignItems={"flex-start"}>
              <Button
                w={"full"}
                leftIcon={<FiFolder />}
                colorScheme={"blue"}
...
function CollapsedHeadingPanel(props: ExpandedCollapsedHeadingPanelProps) {
  ...
  return (
    <>
      ...
      <VStack w="full">
        <HStack w="full">
          <VStack flexWrap={"nowrap"} w={"max-content"} alignItems={"left"}>
            <HStack alignItems="baseline">
              <Heading fontSize={"2xl"} fontFamily={"body"} whiteSpace={"nowrap"} mb={"4!important"} mr={3}>
                {props.machinery.modelName}
              </Heading>
              <Heading fontSize={"md"} fontFamily={"body"} color={"gray.400"} whiteSpace={"nowrap"}>
                {props.machinery.uid}
            ...
            <HStack mt={"-2!important"}>
              <Text whiteSpace={"nowrap"} mt={"0!important"}>
                {props.machinery.modelType}
              </Text>
              <Text color={"gray.200"} mx={1} mt={"0!important"}>
                |
              </Text>
              <Text whiteSpace={"nowrap"} mt={"0!important"}>
                {props.machinery.numHeads} heads
          ...
          {props.type === "dashboard" && (
            <VStack w="full" alignItems={"flex-end"} justifyContent={"center"}>
              <HStack>
                <Button
                  leftIcon={<FiFolder />}
                  colorScheme={"blue"}
...
function DashboardNotSavedPrompt(props: DashboardNotSavedPromptProps) {
  ...
  function createNewDashboard() {
    ...
    props.setDashboard(newDash);

    closePrompt();
  }

  return (
    <AlertDialog isOpen={props.dashboardNotSavePromptObject.open} leastDestructiveRef={cancelRef} onClose={closePrompt}>
      <AlertDialogOverlay>
        <AlertDialogContent>
          ...
          <AlertDialogBody>
            There are unsaved changes in the current dashboard. If you continue all the changes will be lost forever.
            Are you sure?
          </AlertDialogBody>
