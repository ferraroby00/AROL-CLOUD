          ...
          <VStack w={"full"}>
              ...
              <VStack w="full">
                <HStack w="full">
                  ...
                  >
                    ...
                    <Text color={"black"} whiteSpace={"nowrap"} my={"0!important"}>
            ...
            <HStack w={"full"} h={"350px"} pb={3}>
              ...
              >
                ...
                <MapRenderer machinery={props.machineryModalMachinery!!} />
              </MapContainer>
            </HStack>
          </VStack>
        </ModalBody>
...
function MapRenderer(props: MapRendererProps) {
  ...
  return (
    <>
      ...
      />
      <Marker key={props.machinery.uid} position={[props.machinery.geoLocation.x, props.machinery.geoLocation.y]}>
        <Tooltip permanent>{props.machinery.uid}</Tooltip>
      </Marker>
    </>
  );
}
